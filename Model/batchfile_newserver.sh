...
mpirun ./components/mechanisms/x86_64/special -mpi -python run_network.py config_scaled_syn.json True # args: config file, whether use coreneuron

END=$(date)
echo "Done running simulation at $END"

TRIALNAME="short_rand_syn"
